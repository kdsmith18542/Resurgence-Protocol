const DeadCoinStakingPoolABI_input = [
  ...
  {"inputs":[],"name":"deadCoin","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},
...
export const ABIS = {
  ...
  LegacyClaimRegistry: [
    {"type":"function","name":"vaultAddresses","inputs":[{"name":"","type":"bytes32","internalType":"bytes32"}],"outputs":[{"name":"","type":"string","internalType":"string"}],"stateMutability":"view"},
    {"type":"function","name":"burnAddresses","inputs":[{"name":"","type":"bytes32","internalType":"bytes32"}],"outputs":[{"name":"","type":"string","internalType":"string"}],"stateMutability":"view"},
    {"type":"function","name":"submitLegacyClaim","inputs":[{"name":"claim","type":"tuple","internalType":"struct LegacyClaimRegistry.LegacyClaim","components":[{"name":"sourceChainId","type":"bytes32","internalType":"bytes32"},{"name":"sourceAddressHash","type":"bytes32","internalType":"bytes32"},{"name":"evmWallet","type":"address","internalType":"address"},{"name":"proofHash","type":"bytes32","internalType":"bytes32"},{"name":"sourceTxHash","type":"bytes32","internalType":"bytes32"},{"name":"claimType","type":"uint8","internalType":"enum LegacyClaimRegistry.LegacyClaimType"},{"name":"confidenceTier","type":"uint8","internalType":"uint8"},{"name":"lastSeenTimestamp","type":"uint256","internalType":"uint256"},{"name":"dormancySeconds","type":"uint256","internalType":"uint256"},{"name":"rewardAmount","type":"uint256","internalType":"uint256"},{"name":"campaignId","type":"uint256","internalType":"uint256"}]},{"name":"baalsAttestation","type":"bytes","internalType":"bytes"}],"outputs":[],"stateMutability":"nonpayable"}
  ] as const
} as const;
